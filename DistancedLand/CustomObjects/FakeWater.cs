...
namespace DistancedLand.CustomObjects
{
    public class FakeWater : CosmeticSprite
    {
        ...
        public FakeWater(Room room)
        {
            this.room = room;
            this.originalWaterLevel = room.MiddleOfTile(new IntVector2(0, room.Height)).y;
            ...
            float num = -this.leftMargin;
            float num2 = room.PixelWidth + this.rightMargin;
            ...
            this.pointsToRender = Custom.IntClamp((int)((room.game.rainWorld.options.ScreenSize.x + 60f) / this.triangleWidth) + 2, 0, this.surface.GetLength(0));
        ...
        public override void InitiateSprites(RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam)
        {
            ...
            sLeaser.sprites[0] = new WaterTriangleMesh("Futile_White", array, true);
            sLeaser.sprites[0].shader = this.room.game.rainWorld.Shaders["WaterSurface"];
            ...
            sLeaser.sprites[1] = new WaterTriangleMesh("Futile_White", array2, false);
        ...
        public override void DrawSprites(RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam, float timeStacker, Vector2 camPos)
        {
            ...
            {
                int num3 = (i - num) * 2;
                Vector2 vector = this.surface[i, 0].defaultPos + Vector2.Lerp(this.surface[i, 0].lastPos, this.surface[i, 0].pos, timeStacker) - camPos + new Vector2(0f, this.cosmeticSurfaceDisplace);
                Vector2 vector2 = this.surface[i, 1].defaultPos + Vector2.Lerp(this.surface[i, 1].lastPos, this.surface[i, 1].pos, timeStacker) - camPos + new Vector2(0f, this.cosmeticSurfaceDisplace);
                Vector2 vector3 = this.surface[i + 1, 0].defaultPos + Vector2.Lerp(this.surface[i + 1, 0].lastPos, this.surface[i + 1, 0].pos, timeStacker) - camPos + new Vector2(0f, this.cosmeticSurfaceDisplace);
                Vector2 vector4 = this.surface[i + 1, 1].defaultPos + Vector2.Lerp(this.surface[i + 1, 1].lastPos, this.surface[i + 1, 1].pos, timeStacker) - camPos + new Vector2(0f, this.cosmeticSurfaceDisplace);
                ...
                (sLeaser.sprites[0] as WaterTriangleMesh).MoveVertice(num3, vector);
                (sLeaser.sprites[0] as WaterTriangleMesh).MoveVertice(num3 + 1, vector2 + zero);
                (sLeaser.sprites[0] as WaterTriangleMesh).MoveVertice(num3 + 2, vector3);
                (sLeaser.sprites[0] as WaterTriangleMesh).MoveVertice(num3 + 3, ModManager.MSC ? (vector4 + zero) : vector3);
                ...
                (sLeaser.sprites[0] as WaterTriangleMesh).verticeColors[num3 + 1] = Color.Lerp(this.palette.waterSurfaceColor2, this.palette.waterShineColor, num4 * (1f - this.palette.fogAmount));
                (sLeaser.sprites[1] as WaterTriangleMesh).MoveVertice(num3, new Vector2(vector.x + vector.y * 0.3f, y));
                (sLeaser.sprites[1] as WaterTriangleMesh).MoveVertice(num3 + 1, vector);
                (sLeaser.sprites[1] as WaterTriangleMesh).MoveVertice(num3 + 2, new Vector2(vector3.x + vector3.y * 0.3f, y));
                (sLeaser.sprites[1] as WaterTriangleMesh).MoveVertice(num3 + 3, vector3);
            }
            if (ModManager.MSC)
            {
                for (int l = (num2 - num) * 2; l < (sLeaser.sprites[0] as WaterTriangleMesh).vertices.Length; l++)
                {
                    (sLeaser.sprites[0] as WaterTriangleMesh).MoveVertice(l, new Vector2(3400f, this.fWaterLevel - camPos.y + this.cosmeticSurfaceDisplace));
            ...
            (sLeaser.sprites[1] as WaterTriangleMesh).MoveVertice(1, new Vector2(-10f, this.fWaterLevel - camPos.y + this.cosmeticSurfaceDisplace));
            (sLeaser.sprites[1] as WaterTriangleMesh).MoveVertice((sLeaser.sprites[1] as WaterTriangleMesh).vertices.Length - 2, new Vector2(ModManager.MSC ? 3400f : 1400f, this.fWaterLevel - camPos.y + this.cosmeticSurfaceDisplace));
            ...
            if (rCam.followAbstractCreature != null && rCam.followAbstractCreature.realizedCreature != null && rCam.followAbstractCreature.realizedCreature.room == this.room && !rCam.followAbstractCreature.realizedCreature.dead)
            {
                ...
                (sLeaser.sprites[1] as WaterTriangleMesh).color = new Color(Mathf.InverseLerp(0f, rCam.sSize.x, vector6.x), Mathf.InverseLerp(0f, rCam.sSize.y, vector6.y), b);
            }
            else
            {
                (sLeaser.sprites[1] as WaterTriangleMesh).color = new Color(0f, 0f, 0f);
            }
            (sLeaser.sprites[0] as WaterTriangleMesh).verticeColors[(sLeaser.sprites[0] as WaterTriangleMesh).verticeColors.Length - 2] = this.palette.waterSurfaceColor1;
